...
(function (e, undefined) {
  ...
  (t = x(o)),
    (function (e, undefined) {
              ...
              ? ((p = t),
                ...
                (n.attributes = lt(function (e) {
                  return (
                    ...
                    ct(R, pt, null == e.getAttribute("disabled")),
                    (e.className = "i"),
                ...
                ct("value", ht, n.attributes && n.input),
                ...
                (y =
                  st(f.contains) || f.compareDocumentPosition
                    ? function (e, t) {
      ...
      function jt() {}
      (jt.prototype = i.filters = i.pseudos),
        (i.setFilters = new jt()),
    ...
    x.fn.extend({
      data: function (e, t) {
        ...
        if (e === undefined) {
          if (
            this.length &&
            ((s = L.get(i)), 1 === i.nodeType && !H.get(i, "hasDataAttrs"))
          ) {
  ...
  function gt(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        H.hasData(e) &&
        ((o = H.access(e)), (s = H.set(t, o)), (l = o.events))
      ) {
  ...
  function qt(e, t) {
    ...
    for (; a > s; s++)
      (r = e[s]),
        r.style &&
          ((o[s] = H.get(r, "olddisplay")),
          (n = r.style.display),
          t
            ? (o[s] || "none" !== n || (r.style.display = ""),
              "" === r.style.display &&
                Lt(r) &&
                (o[s] = H.access(r, "olddisplay", Rt(r.nodeName))))
            : o[s] ||
              ((i = Lt(r)),
              ((n && "none" !== n) || !i) &&
                H.set(r, "olddisplay", i ? n : x.css(r, "display"))));
    for (s = 0; a > s; s++)
      (r = e[s]),
        r.style &&
  ...
  function An(e, t, n) {
    ...
    if (!x.isEmptyObject(c)) {
      h ? "hidden" in h && (f = h.hidden) : (h = H.access(e, "fxshow", {})),
        o && (h.hidden = !f),
        f
          ? x(e).show()
          : l.done(function () {
